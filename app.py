...
1. ห้าม Paraphrase หรือเปลี่ยนคำศัพท์ไปใช้คำอื่นเด็ดขาด (เช่น "น่ารำคาญ" ห้ามเปลี่ยนเป็น "ระคายเคือง", "โอเค" ห้ามเปลี่ยนเป็น "ตกลง")
    ...
    if uploaded_file and st.button("🚀 เริ่มผลิตคลิปไร้หน้า"):
        with st.spinner("กำลังทำงาน..."):
            ...
            if faceless_mode != "ไม่ใช้ (ใช้วิดีโอต้นฉบับ)":
                ...
                # 🚀 V.27 อัปเกรดคำสั่งตอนจบ (โหมดประกอบ B-Roll)
                ...
                # 🚀 V.27 อัปเกรดคำสั่งตอนจบ (โหมดวิดีโอต้นฉบับ)
...
# =========================================================
    ...
    if uploaded_videos and st.button("🚀 รวมคลิปและสร้างซับไตเติล"):
        ...
        with st.spinner("กำลังฟังเสียงและถอดความ..."):
            ...
            # 🚀 V.27 อัปเกรดคำสั่งตอนจบ (โหมด Join & Sub)
