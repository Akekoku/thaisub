...
# 🌟 V.37 ย้อนกลับไปใช้กฎเหล็ก V.33 (ห้ามแต่งประโยค ห้ามหาทำ)
...
if app_mode == "🎭 โหมด 1: สร้างคลิปไร้หน้า (Faceless)":
    ...
    if uploaded_file and st.button("🚀 เริ่มผลิตคลิปไร้หน้า"):
        with st.spinner("กำลังทำงาน..."):
            ...
            # 🌟 ถอย Whisper กลับเป็นแบบคลีนๆ ปล่อยให้มันเดาคำจากบริบทเสียงธรรมชาติ ไม่ยัดเยียด
            ...
            if sub_config["ai_proof"]:
                with st.spinner("🧠 กำลังให้ AI ตรวจทานคำผิดแบบเข้มงวด..."):
