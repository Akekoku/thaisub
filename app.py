...
# 🌟 V.35 อัปเกรด AI พิสูจน์อักษร ให้แก้คำพ้องเสียงและคำเพี้ยนได้ฉลาดขึ้น
...
หน้าที่ของคุณ: แก้ไข "คำที่ AI ฟังเพี้ยน" หรือ "สะกดผิดบริบท" ให้กลับมาเป็นภาษาพูดที่ถูกต้องและเป็นธรรมชาติ

ตัวอย่างการแก้คำเพี้ยนที่มักพบ (Phonetic Errors):
...
กฎการทำงาน:
1. ตรวจสอบบริบทของประโยค และแก้ไขเฉพาะคำที่ผิดเพี้ยนจากการฟังให้ถูกต้อง
2. เปลี่ยนคำทับศัพท์ภาษาอังกฤษที่เขียนผิด ให้เป็นภาษาไทยที่ถูกต้อง (เช่น hit -> ฮิต)
3. ห้ามแต่งประโยคใหม่ ห้ามลบประโยคทิ้ง คงโครงสร้างประโยคเดิมไว้ให้มากที่สุด
4. หากประโยคไหนถูกต้องอยู่แล้ว ห้ามแก้ไขใดๆ ทั้งสิ้น
5. ตอบกลับเป็น JSON Object เท่านั้น รูปแบบ: {{"corrected": [{{"id": "0", "text": "ข้อความ"}}]}}
{hint_text}
ข้อความต้นฉบับ:
