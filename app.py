...
"""
        ...
        try:
            ...
            cmd = [
                ...
                '-c:v', 'libx264',   # 🌟 บังคับใช้เอนจินวิดีโอ H.264 มาตรฐานสากล
                '-crf', '17',        # 🌟 ตั้งค่าความชัด (17-18 คือชัดตาแตก ใกล้เคียงต้นฉบับสุดๆ)
                '-preset', 'slow',   # 🌟 ยอมเรนเดอร์ช้าลงนิดนึง เพื่อแลกกับคุณภาพที่เนียนและไฟล์ไม่ใหญ่เวอร์
                '-c:a', 'copy',      # 🌟 ส่วนเสียง ไม่ต้องเรนเดอร์ใหม่ ก๊อบปี้ความชัด 100% จากต้นฉบับมาเลย
                'output.mp4'
            ]
