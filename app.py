...
def ai_proofread_segments(client, segments, user_replacements=""):
    ...
    # ดึงคำใบ้จากที่น้าตั้งค่าไว้ในกล่องแทนที่คำ มาช่วยใบ้ให้ AI ด้วย
    hint_text = ""
        ...
        for attempt in range(3):
            try:
                res = client.chat.completions.create(
                    ...
                    temperature=0.0, # บังคับให้ไม่ใช้จินตนาการเลย
...
def render_subtitle_ui(key_prefix):
    defaults = {
        ...
        "fs": 18, "ot": 1, "mw": 100, "mv": 50, "ll": "🚫 บังคับไม่เกิน 2 บรรทัด", "ai_proof": False
    }
    ...
    for p_name, p_data in profiles.items():
        ...
        if "ai_proof" not in p_data: p_data["ai_proof"] = False
    ...
    if uploaded_file and st.button("🚀 เริ่มผลิตคลิปไร้หน้า"):
        with st.spinner("กำลังทำงาน..."):
            ...
            for seg in raw_segments:
                ...
                # ใช้ Regex แทนที่คำซ้ำอีกรอบชัวร์ๆ ตามที่น้ากรอก
