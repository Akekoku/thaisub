...
if app_mode == "🎭 โหมด 1: สร้างคลิปไร้หน้า (Faceless)":
    ...
    if st.session_state.m1_segments:
        ...
        st.info("💡 แก้ไขคำผิด ลบหรือเพิ่มบรรทัดในตารางได้เต็มที่ (หน้าจอจะไม่กระตุก) เมื่อแก้เสร็จแล้วให้กดปุ่ม **'💾 ยืนยันการแก้ไข'** ด้านล่างสุดครับ")
        
        # 🌟 ใส่ Form ครอบ Editor ไว้กันการรีเฟรชออโต้!
        with st.form("m1_editor_form"):
            ...
            if submit_edits_m1:
                ...
                st.success("✅ บันทึกข้อความล่าสุดแล้ว! เลื่อนลงไปตั้งค่าฟอนต์และกดพรีวิวได้เลยครับ")
