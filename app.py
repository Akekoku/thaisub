...
def render_subtitle_ui(key_prefix):
    ...
    with st.expander("เปิดเครื่องมือปรับแต่ง (เอฟเฟกต์, กรอบข้อความ, สี)", expanded=True):
        ...
        return {
            ...
            "force_2_lines": force_max_2_lines
        }
...
if app_mode == "🎭 โหมด 1: สร้างคลิปไร้หน้า (Faceless)":
    ...
    # เรียกใช้ UI ซับไตเติลแบบเต็มรูปแบบ
    ...
    if uploaded_file and st.button("🚀 เริ่มผลิตคลิปไร้หน้า"):
        with st.spinner("กำลังทำงาน..."):
            ...
            # นำระบบบังคับ 2 บรรทัด และจัดความกว้างกลับมา
